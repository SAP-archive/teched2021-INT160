...
- [Exercise 3 - Deployment & Cold debugging](exercises/exercise3/)
    ...
    - Once you have finished designing your project, you can generate a package from it. You will then create an environment for your project. An environment represents the functional landscape in which your automation is deployed and executed. After you have added the RPA Challenge package to your environment, you will add an agent.
